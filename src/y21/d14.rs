...
fn step(original: &str, rules: &HashMap<(char, char), char>) -> String {
...
mod tests {
    ...
    fn test_part_1_example() {
        ...
        assert_eq!(Day14 {}.part_1(&test_file), "1588");
    }

    #[test]
    fn test_part_1_input() {
        let test_file = get_test_file!("input.txt");
        assert_eq!(Day14 {}.part_1(&test_file), "2360");
    }

    #[test]
    fn test_part_2_example() {
        let test_file = get_test_file!("example.txt");
        assert_eq!(Day14 {}.part_2(&test_file), "2188189693529");
    }

    #[test]
    fn test_part_2_input() {
        let test_file = get_test_file!("input.txt");
        assert_eq!(Day14 {}.part_2(&test_file), "2967977072188");
    }
}
