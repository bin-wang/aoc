...
fn expand(m: &[Vec<u32>]) -> Vec<Vec<u32>> {
...
fn dijkstra(risk_levels: &[Vec<u32>]) -> Vec<Vec<u32>> {
...
fn a_star_search(risk_levels: &[Vec<u32>]) -> Vec<Vec<u32>> {
    let h = risk_levels.len();
    let w = risk_levels.first().unwrap().len();
...
mod tests {
    ...
    fn test_part_1_example() {
        ...
        assert_eq!(Day15 {}.part_1(&test_file), "40");
    }

    #[test]
    fn test_part_1_input() {
        let test_file = get_test_file!("input.txt");
        assert_eq!(Day15 {}.part_1(&test_file), "602");
    }

    #[test]
    fn test_part_2_example() {
        let test_file = get_test_file!("example.txt");
        assert_eq!(Day15 {}.part_2(&test_file), "315");
    }

    #[test]
    fn test_part_2_input() {
        let test_file = get_test_file!("input.txt");
        assert_eq!(Day15 {}.part_2(&test_file), "2935");
    }
}
